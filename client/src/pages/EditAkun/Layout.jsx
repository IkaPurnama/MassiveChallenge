            ...
            >
              ...
              <Form>
                ...
                <div className="d-flex justify-content-end">
                  ...
                  >
                    <button className="custom-popup-batal-button" onClick={handleSaveImage}>
                      Kembali
                    </button>
                  </Link>
                  <button className="custom-popup-simpan-button" type="submit" onClick={handleSaveImage}>Simpan</button>
                </div>
              </Form>
            </div>
          </div>
